...
class ASTVectorizer:
    ...
    NODE_TYPE_MAP = {
        "function_definition": 0, "class_definition": 1, "decorator": 2,
        "if_statement": 3, "for_statement": 4, "while_statement": 5,
        "try_statement": 6, "with_statement": 7, "return_statement": 8,
        "assignment": 9, "augmented_assignment": 10, "call": 11,
        "binary_operator": 12, "unary_operator": 13, "comparison_operator": 14,
        "boolean_operator": 15, "lambda": 16, "list_comprehension": 17,
        "set_comprehension": 18, "dict_comprehension": 19, "generator_expression": 20,
        "subscript": 21, "attribute": 22, "import_statement": 23,
        "import_from_statement": 24, "argument": 25, "parameter": 26,
        "string": 27, "number": 28, "identifier": 29, "comment": 30,
    }
